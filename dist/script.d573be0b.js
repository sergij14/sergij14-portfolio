...
var itemsContainer = document.querySelector(".portfolio__row");

var getItems = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var _contentful, items;
...
var renderItems = function renderItems(items) {
  items.forEach(function (item) {
    var img = item.fields.img.fields.file.url;
    var _item$fields = item.fields,
        title = _item$fields.title,
        description = _item$fields.description,
        fonts = _item$fields.fonts,
        files = _item$fields.files,
        icons = _item$fields.icons,
        api = _item$fields.api,
        link = _item$fields.link;
    itemsContainer.insertAdjacentHTML("beforeend", " \n    <div class=\"portfolio__item mar-b-2\">\n    <div class=\"portfolio__item__img\">\n    <a target=\"_blank\" href=\"".concat(link, "\">\n     <img src=\"").concat(img, "\" alt=\"").concat(title, "\">\n     </a>\n      <a class=\"btn\" target=\"_blank\" target=\"_blank\" href=\"").concat(link, "\">View Demo</a>\n    </div>\n    <div class=\"portfolio__item__info pad-1\">\n    <p>").concat(description, "</p>\n    <span>Files: ").concat(files, "</span>\n    <span>Fonts: ").concat(fonts, "</span>\n    <span>Icons: ").concat(icons ? icons : "No Icons", "</span>\n    <span>API: ").concat(api ? api : "No API", "</span>\n    </div>\n    <h4><a target=\"_blank\" href=\"").concat(link, "\">").concat(title, "</a></h4>\n    </div>\n    "));
  });
};
